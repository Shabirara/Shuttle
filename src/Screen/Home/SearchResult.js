        ...
        <>
            ...
            <Modal isVisible={isSortVisible}
                ...
                <View style={styles.sortModal}>
                    ...
                    <Button title='Sort' onPress={() => setSortVisible(false)} buttonStyle={styles.sortButton}
                        titleStyle={styles.sort} />
                </View>
            </Modal>

            <Modal isVisible={isFilterVisible} swipeDirection='down' onSwipeComplete={() => setFilterVisible(false)} style={{ marginHorizontal: 0, marginBottom: 0 }}>
                <ScrollView>
                    <View style={styles.changeModal}>
                        ...
                        <Button title='Sort' onPress={() => setFilterVisible(false)} buttonStyle={styles.sortButton}
                            titleStyle={styles.sort} />
                    </View>
                </ScrollView>
            </Modal>
            ...
            <SafeAreaView style={{ flex: 1 }}>
                ...
                <View style={styles.floatings}>
                    <View style={styles.button}>
                        ...
                        <TouchableOpacity style={styles.touchable} onPress={toggleFilterModal}>
