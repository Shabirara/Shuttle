...
import { View, Text, StyleSheet, TouchableOpacity, Button, ActivityIndicator, ScrollView, FlatList } from 'react-native'
...
const REVIEW = [
    {
        ...
        comment: '"Bisnya nyaman dan bersih, tempat duduknya enak perjalanan jauh serasa dekat karna tidak terasa capek"'
    },
    {
...
export default function BusDetails(props) {
    ...
    const renderReview = ({ item }) => (
        <Item reviewer={item.reviewer} review={item.review} comment={item.comment} />
    )
    ...
    return (
        <ScrollView>
            ...
            <View style={styles.contentContainer}>
                <View style={{ alignItems: 'center', marginRight: ms(10), justifyContent: 'space-between', height: ms(130) }}>
                ...
                <View style={{ flexDirection: 'column' }}>
                    <View style={{ flexDirection: 'row' }}>
                        <View style={{ alignItems: 'center' }}>
                            <MaterialCommunityIcons name='circle-outline' color='#0F5996' size={ms(20)} style={{ marginVertical: ms(-5) }} />
                            <FontAwesome name='ellipsis-v' color='#0F5996' style={{ marginBottom: ms(-3), width: ms(1) }} />
                        ...
                        <View style={{ flexDirection: 'column', marginLeft: ms(10), justifyContent: 'space-between', height: ms(130) }}>
                            <View style={styles.contentBetween}>
                                <Text style={styles.fontKecil}>Terminal Lebak Bulus</Text>
                                <Text style={styles.abuKecil}>
                                    Jl. Lebak Bulus Jaya Abadi RT 06 RW 07 Jakarta
                                    Selatan
                                </Text>
                            </View>
                            <View style={styles.contentBetween}>
                                <Text style={styles.fontKecil}>Terminal Purabaya Bungurasih</Text>
                                <Text style={styles.abuKecil}>Jl. Bungurasih Timur, Waru, Sidoarjo</Text>
                            </View>
                        </View>
                    </View>
                </View>
            ...
            <View style={styles.contentContainer}>
                <View style={[styles.columnCenter, { width: '20%' }]}>
                    ...
                    <Text style={[styles.fontKecil, { textAlign: 'center' }]}>Air Conditioner</Text>
                </View>
                <View style={[styles.columnCenter, { width: '20%' }]}>
                    <Image
                ...
                <View style={[styles.columnCenter, { width: '20%' }]}>
                    ...
                    <Text style={[styles.fontKecil, { textAlign: 'center' }]}>Free Meal</Text>
                </View>
                <View style={[styles.columnCenter, { width: '20%' }]}>
                    <Image
                ...
                <View style={[styles.columnCenter, { width: '20%' }]}>
                    ...
                    <Text style={[styles.fontKecil, { textAlign: 'center' }]}>Comfortable Seat</Text>
                </View>
            </View>

            <View style={styles.headerContainer}>
                <Text style={styles.fontBesar}>Passenger Rating & Review</Text>
                <View style={[styles.rowBawah, { width: ms(58), justifyContent: 'space-between' }]}>
